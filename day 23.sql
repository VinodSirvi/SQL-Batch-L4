...
-- rank() , dense_rank()  and row_number() difference batana hai
-- ==============================
-- rank() => rank skip kar dega agar value same hui toh 
-- dense_rank() => rank skip nhi karega if the value is same 
