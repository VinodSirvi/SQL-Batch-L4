-- self join 
-- self join is a type of join a table is connected with itself 
...
-- 1
select emp.emp_id , emp.emp_name , emp.manager_id  , emp.salary, mngr.salary, mngr.emp_id , mngr.emp_name from employee as emp 
